        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Create fee category</h3>
                </div>
                <div class="card-body">
                    <div class="ml-auto">
                        <form action="{{route('setup.fee.category.add')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="name"></label>
                                <input class="result form-control" type="text" id="name" name="name" value="{{old('name')}}" placeholder="Enter fee category">
