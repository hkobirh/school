    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ml-auto">
                        <form action="{{route('setup.subject.assign.update',$editData[0]->class_id)}}" method="post"
                                    ...
                                    <div class="col-md-5 form-group">
                                        ...
                                        <select name="class_id" id="class_id"
                                            ...
                                            @foreach($classes as $cls)
                                                <option
                                                    value="{{$cls->id}}"{{($editData[0]->class_id==$cls->id)?"selected":""}}>{{$cls->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input class="result form-control" type="text" id="fmark"
                                                   name="full_mark[]"
                                                   value="{{$edit->full_mark}}" placeholder="Full mark">
                                            <span
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input class="result form-control" type="text" id="pmark"
                                                   name="pass_mark[]"
                                                   value="{{$edit->pass_mark}}" placeholder="Pass mark">
                                            <span
                                                class="text-danger">@error('full_mark'){{$message}}@enderror</span>
                                        </div>
                                        <div class="col-md-2 form-group">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="lni lni-circle-plus"></i> Update
                            </button>
                        </form>
                    </div>
                </div>
