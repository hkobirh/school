    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('student.registration.promotion',$editData->student_id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="text-right">
                            <button class="btn btn-light-info btn-lg">Promote student</button>
                        </div>
                    </form>
                </div>
            </div>
